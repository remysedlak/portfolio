...
function Intro() {
    return (
        <div className="flex items-center justify-center flex-col text-center pt-10 pb-6">
            ...
            <div className="p-2 flex flex-col sm:flex-col md:flex-col lg:flex-row xl:flex-row justify-around items-center space-y-6 lg:space-y-0 lg:space-x-12">
                <img src="/assets/me.jpg" alt="Remy Sedlak" className="w-48 h-48 rounded-full" />
