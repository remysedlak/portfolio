...
return (
    ...
    />
    <div className={`text-center flex flex-col sm:flex-col md:flex-col lg:flex-row xl:flex-row items-center space-y-6 lg:space-y-0 lg:space-x-12 ${617 < window.innerWidth < 780  ? 'mb-8':'mb-4'}`}>
    ...
    <div className="sm:hidden block flex flex-row space-x-12 py-8 mt-8">
    <a
