        ...
        <div className="flex items-center justify-center flex-col text-center text-black dark:text-gray-200 pt-8 transition-all duration-400">
            ...
            <div className="text-center flex flex-col sm:flex-col md:flex-col lg:flex-row xl:flex-row items-center space-y-6 lg:space-y-0 lg:space-x-12">
                <div className="md:flex md:flex-col justify-around w-full rounded-md p-4 text-center ">
                    <h4 className="text-base text-xl md:text-2xl lg:text-2xl mt-2 md:max-w-3xl max-w-md  md:max-w-3xl mx-auto text-center">
                    ...
                    <div className="flex flex-col h-8 items-center sm:my-4 mb-4 my-4 md:my-16 lg:mt-20 xl:mt-20">
                        ...
                        <div className="flex flex-wrap sm:flex-row md:flex-row lg:flex-grid justify-center my-4 gap-x-4 gap-y-4 md:gap-x-3 md:gap-y-3 lg:gap-x-4 lg:gap-y-4  w-3/4 lg:w-full  mx-auto">
                            <a className='hover:opacity-100 w-16 h-16 opacity-80'>
                            ...
                            <a className='hover:opacity-100 w-16 h-16 opacity-80'>
                                <svg width="72" height="72" viewBox="0 0 100 100" fill="text-black dark:text-white" xmlns="http://www.w3.org/2000/svg">
                                    <g id="aws">
                                        <g id="aws_2">
            ...
            <div className="mt-64 md:mt-36"></div>
            <h1 className="md:hidden block font-semibold text-3xl p-8 dark:text-gray-300 text-gray-800">Let's connect!</h1>
