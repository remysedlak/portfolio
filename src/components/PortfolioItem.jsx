...
function PortfolioItem({ imgUrl, title, stack, link, desc }) {
    return (
        <div className="relative group border-2 rounded-lg overflow-hidden border-black">
            <div className="flex flex-row items-center justify-between absolute top-0 left-0 w-full bg-gray-100 dark:bg-gray-300 bg-opacity-100 text-black border-b-2 border-black text-left pl-5 py-1">
